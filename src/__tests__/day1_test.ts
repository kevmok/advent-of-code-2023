...
import { Trebuchet } from 'challenges/day1/part1';
import { Trebuchet_2 } from 'challenges/day1/part2';
...
describe('Day 1: Trebuchet - Part 1', () => {
  test('Example Test', () => {
    ...
    expect(Trebuchet(testArray)).toBe(142);
  });
  test('Challenge Test', () => {
    expect(Trebuchet(inputArray)).toBe(55971);
  });
});
describe('Day 1: Trebuchet - Part 2', () => {
  test('Example Test', () => {
    const testArray = [
      'two1nine',
      'eightwothree',
    ...
    expect(Trebuchet_2(testArray)).toBe(281);
  });
  test('Challenge Test', () => {
    expect(Trebuchet_2(inputArray)).toBe(54719);
  });
});
