...
import { CubeConundrum } from 'challenges/day2/part1';
import { CubeConundrum_2 } from 'challenges/day2/part2';
...
const puzzleInput = `Game 1: 4 blue, 16 green, 2 red; 5 red, 11 blue, 16 green; 9 green, 11 blue; 10 blue, 6 green, 4 red
...
describe('Day 2: Cube Conundrum - Part 1', () => {
  test('Example Test', () => {
    expect(CubeConundrum(gameString)).toBe(8);
  });
  test('Challenge Test', () => {
    expect(CubeConundrum(puzzleInput)).toBe(2685);
  });
});

describe('Day 2: Cube Conundrum - Part 2', () => {
  test('Example Test', () => {
    expect(CubeConundrum_2(gameString)).toBe(2286);
  });
  test('Challenge Test', () => {
    expect(CubeConundrum_2(puzzleInput)).toBe(83707);
  });
});
